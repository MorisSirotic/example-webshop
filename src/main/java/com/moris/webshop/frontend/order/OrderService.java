...
import com.moris.webshop.common.OrderReturnRequest;
import com.moris.webshop.common.Product;
import com.moris.webshop.common.exception.OrderNotFoundException;
import com.moris.webshop.common.order.Order;
import com.moris.webshop.common.order.OrderDetail;
import com.moris.webshop.common.order.OrderStatus;
import com.moris.webshop.common.order.OrderTrack;
import com.moris.webshop.common.order.PaymentMethod;
import com.moris.webshop.frontend.checkout.CheckoutInfo;
...
public class OrderService {
	...
	public Page<Order> listForCustomerByPage(Customer customer, int pageNum, String sortField, String sortDir,
		...
		if (keyword != null) {
			return repo.findAllByKeyword(keyword, customer.getId(), pageable);
		}
